...
SECRET_KEY = 'django-insecure-h-*is*pgd3#nh6618o*ygacb!v%f8lh37#8##h1-dkr&&t1u=%'
...
INSTALLED_APPS = [
    ...
    'apps.core', # Підключаємо наш додаток
    'apps.users', # Додаємо `users`
]
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [], # папки для шаблонів
        # підключення глобальної папки
